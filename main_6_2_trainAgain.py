...
TrainFCNFolder = '/home/sepideh/Documents/illuminChngeLrning/stackedCNN_chngTrain/prediction_output_v1_trainImg/';
...
# paired reg map (image-level prior)
TestFCNFolder = '/home/sepideh/Documents/illuminChngeLrning/stackedCNN_chngTrain/prediction_output_v1_my/last_main_6_2/';
...
def cnn_pred_mask(cnn, Test):
    ...
    for im_id in range(len(X)):
        ...
        print 'put mean in middle of segments ', time.time() - middle_time;
...
def load_data(image_folder, mask_folder, fcn_folder):
    ...
    for fn in os.listdir(image_folder):
        if os.path.isfile(image_folder + fn):
            ...
            im_meaned[:, :, 3] = (fcn - 59.11) / 100.0;

            edge = canny_edge(im); #canny_edge_on_mask(mask);
...
# cnn init
cnn.load_params_from('/home/sepideh/Documents/illuminChngeLrning/stackedCNN_chngTrain/data_cache/__priormap_svm/_cnn_V1-cache_train_v1_finetune_priormapsvam.pkl');
